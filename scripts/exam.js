const questions = [
    {
        ...
        options: ["to use when mixing concrete", "as a wood support in a concrete form", "as a part of a wood shoring system", "to support layout strings when locating foundations"],
        answer: 3
    },
    {
    ...
    {
        question: "Which of the following may approve a change order on a public works project?",
    ...
    },
    {
        ...
        options: ["4 square feet", "5.7 square feet", "6 square feet", "8.2 square feet"],
        answer: 1
    },
    {
    ...
    {
        question: 'A contractor installs a handrail along a stairway. The handrail is 1-5/8" in diameter and is installed 1-3/4" from the wall. Based on this installation, does the handrail meet building codes?',
        options: ["Yes", 'No, the handrail should be 1-3/4" in diameter and installed 2" from the wall', 'No, the handrail should be 2" in diameter and installed 2" from the wall', 'No, the handrail should be 1" in diameter and installed 1-1/2" from the wall'],
        answer: 0
    },
    {
        question: "If Eric is selling or negotiating contracts at a client’s home and does not hold a Home Improvement Salesperson Registration, what kind of charge can the Registrar of Contractors impose on Eric?",
        options: ["Fine of $5,000", "120 days in county jail", "Misdemeanor", "Felony"],
        answer: 2
    },
    {
        question: "Refer to the diagram. Identify the jumper connecting the neutral busbar to the metal of the distribution box.",
        options: ["System bonding jumper", "Main bonding jumper", "Grounding rod jumper", "Feeders tap jumper"],
...
const translations = [
    {
        ...
        options: ["搅拌混凝土时使用的", "作为混凝土结构中的木材支撑", "作为木护栏系统的一部分", "在确定地基位置时，支持布局弦线"],
    },
    {
    ...
    {
        question: "所有应报告的工伤和疾病都应该在在多长时间之内报告给Cal/OSHA表格5020？",
        options: ["24小时", "48小时", "三天", "五天"],
    },
    {
        question: "一个承包商沿着楼梯安装扶手。扶手的直径为1-5/8英寸，安装在离墙1-3/4英寸的地方。根据这种安装方式，该扶手是否符合建筑规范？",
        options: ["是", "不，扶手的直径应该是1-3/4英寸，安装在离墙2英寸的地方。", "不，扶手的直径应该是2英寸，安装在离墙2英寸的地方。", "不，扶手的直径应该是1英寸，安装在离墙1-1/2英寸的地方。"],
    },
    {
        question: "如果Eric在客户家中进行销售或谈判合同，并且没有持有家庭装修销售人员的注册资格，那么承包商注册局可以对Eric提出什么样的指控？",
    ...
    methods: {
        ...
        flag() {
            if(this.flaggedQuestions.includes(this.currentIndex)){
                this.flaggedQuestions = this.flaggedQuestions.filter(q => q !== this.currentIndex)
            }
            else{
